...
# Update NavigationBar items colors and label overflow
...
# Update the Box containing the bottomBar
bottom_box_target = """        }
      }
    }
  } { innerPadding ->"""

bottom_box_replacement = """        }
      }
    }
  } { innerPadding ->"""
  
# Actually, the bottomBar replacement left an extra bracket?
# No, Box uses one, NavigationBar uses one.

# Let's fix the sticky header
header_target = """           Row(
               modifier = Modifier
                   .fillMaxWidth()
